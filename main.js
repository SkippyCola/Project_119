...
document.getElementById("draw_what").innerHTML = "Sketch to be drawn : " + sketch;
timer_counter = 0;
timer_check = 0;
drawn_sketch = "";
answer_holder = 0;
